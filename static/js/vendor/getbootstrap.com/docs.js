!(function (a, b) {
  ...
  return function (c) {
    ...
    (this.options = c || {}),
      ...
      (this.add = function (k) {
        ...
        if (
          (a(this.options),
          "touch" === (m = this.options.visible) &&
            (m = this.isTouchDevice() ? "always" : "hover"),
          0 === (e = b((k = k || "h2, h3, h4, h5, h6"))).length)
        )
          return this;
        for (
          null === document.head.querySelector("style.anchorjs") &&
            (((f = document.createElement("style")).className = "anchorjs"),
            f.appendChild(document.createTextNode("")),
            void 0 ===
            (k = document.head.querySelector('[rel="stylesheet"],style'))
          ...
          if (this.hasAnchorJSLink(e[c])) l.push(c);
          else {
            if (e[c].hasAttribute("id")) h = e[c].getAttribute("id");
            else if (e[c].hasAttribute("data-anchor-id"))
              h = e[c].getAttribute("data-anchor-id");
            else {
              for (
                g = p = this.urlify(e[c].textContent), n = 0;
                (i = o.indexOf((g = void 0 !== i ? p + "-" + n : g))),
                  (n += 1),
                  -1 !== i;

              );
              (i = void 0), o.push(g), e[c].setAttribute("id", g), (h = g);
            }
            ((d = document.createElement("a")).className =
              ...
              "left" === this.options.placement
                ...
                : ((d.style.paddingLeft = ".375em"), e[c].appendChild(d));
          }
      ...
      (this.remove = function (f) {
        for (var d, e, c = b(f), a = 0; a < c.length; a++)
          (e = c[a].querySelector(".anchorjs-link")) &&
            (-1 !== (d = this.elements.indexOf(c[a])) &&
              this.elements.splice(d, 1),
            c[a].removeChild(e));
        return this;
      }),
  ...
  !(function (b, a) {
    ...
    return (
      (c = {
        134: function (p, a, b) {
            ...
            return (
              ...
              (c = [
                ...
                },
                {
                  key: "selectTarget",
                  value: function () {
                    (this.selectedText = f()(this.target)), this.copyText();
                  },
                },
                {
                  key: "copyText",
          ...
          function o(a) {
            ...
            return function () {
              ...
              return (
                ...
                (f = this),
                !(e = e) || ("object" !== c(e) && "function" != typeof e)
                  ? (function (a) {
          ...
          function e(a, b) {
            if (((a = "data-clipboard-".concat(a)), b.hasAttribute(a)))
        ...
        370: function (c, e, b) {
          ...
          c.exports = function (b, c, e) {
            if (!b && !c && !e) throw new Error("Missing required arguments");
            if (!a.string(c))
            ...
            if (a.string(b))
              return (b = b), (c = c), (e = e), d(document.body, b, c, e);
            throw new TypeError(
          ...
          a.exports = function (a) {
            var c,
              b =
                "SELECT" === a.nodeName
                  ? (a.focus(), a.value)
                  : "INPUT" === a.nodeName || "TEXTAREA" === a.nodeName
    ...
    function a(d) {
      ...
      return c[d](e, e.exports, a), e.exports;
    }
    var c, b;
  }),
  (function () {
  ...
  (function () {
    ...
    var a = document.getElementById("search-input"),
      c;
    b;
    if (!window.docsearch || !a) return;
    (b = a.getAttribute("data-bd-docs-version")),
          ...
          return a.map(function (a) {
            ...
            return (
              (a.url = window.location.origin.startsWith(b)
                ...
                : a.url.replace(b, "/")),
              a.anchor === "content" &&
                ((a.url = a.url.replace(/#content$/, "")), (a.anchor = null)),
              a
            );
          });
        },
